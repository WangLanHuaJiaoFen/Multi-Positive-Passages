...
class TevatronTrainer(Trainer):
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        # Build the training DataLoader explicitly so the paired query/passage
        # collator controls how each batch is flattened and padded.
        return DataLoader(
            self.train_dataset,
    ...
    def compute_loss(self, model, inputs):
        ...
        # Delegate loss computation to the model; dense retrieval losses depend
        # on both query and passage representations.
        return model(query=query, passage=passage).loss

    def training_step(self, *args):
        # HuggingFace Trainer handles backward, optimizer step, and gradient
        # clearing after compute_loss returns. Scale back the distributed loss
        # when negatives have already been gathered across devices.
